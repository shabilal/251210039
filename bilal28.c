...
void inisialisasiData() {
    ...
    strcpy(dataMobil[0].model, "Land Crusier");
    dataMobil[0].tahun = 2025;
    strcpy(dataMobil[0].warna, "Hitam");

    strcpy(dataMobil[1].merk, "Honda");
    strcpy(dataMobil[1].model, "NSX");
    dataMobil[1].tahun = 2020;
    strcpy(dataMobil[1].warna, "Merah");

    strcpy(dataMobil[2].merk, "Hyundai");
    strcpy(dataMobil[2].model, "Palisade");
    dataMobil[2].tahun = 2023;
    strcpy(dataMobil[2].warna, "Putih");
